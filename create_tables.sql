...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'RECORD')
        CREATE TABLE RECORD (
            TEAM_ID         VARCHAR(25)     NOT NULL,
    ...
    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'GAMES')
        CREATE TABLE GAMES (
            ...
            CONSTRAINT FK_GAME_PICKS
                ...
                ON DELETE RESTRICT
                ON UPDATE CASCADE
            CONSTRAINT FK_GAME_BOX_SCORES
                FOREIGN KEY (GAME_ID) REFERENCES BOX_SCORES(GAME_ID)
                ON DELETE RESTRICT
                ON UPDATE CASCADE

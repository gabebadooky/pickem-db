...
CREATE PROCEDURE PROC_CREATE_USER (
    ...
    IN IN_PWDHASH VARCHAR(150),
    IN IN_DISPLAY_NAME VARCHAR(50),
    IN IN_FAVORITE_TEAM VARCHAR(100),
...
BEGIN
	...
	ELSE
		...
		INSERT INTO USERS (USERNAME, PWDHASH, DISPLAY_NAME, FAVORITE_TEAM, NOTIFICATION_PREF, EMAIL_ADDRESS, PHONE) 
		VALUES (IN_USERNAME, IN_PWDHASH, IN_DISPLAY_NAME, IN_FAVORITE_TEAM, IN_NOTIFICATION_PREF, IN_EMAIL_ADDRESS, IN_PHONE);
        COMMIT;
        ...
        INSERT INTO USER_TEAM_NOTES (USER_ID, TEAM_ID, NOTES)
			SELECT U.USER_ID, T.TEAM_ID, NULL

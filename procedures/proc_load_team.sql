...
CREATE PROCEDURE PROC_LOAD_TEAM (
	...
	IN IN_G5_CONFERENCE BOOLEAN,
	IN IN_TEAM_LOGO_URL VARCHAR(50)
)
BEGIN
    ...
    IF (SELECT COUNT(*) FROM TEAMS WHERE TEAM_NAME = IN_TEAM_NAME AND TEAM_MASCOT = IN_TEAM_MASCOT) = 0 THEN
        ...
        INSERT INTO TEAMS (TEAM_ID, CBS_CODE, ESPN_CODE, FOX_CODE, VEGAS_CODE,
							...
							TEAM_NAME, TEAM_MASCOT, G5_CONFERENCE, TEAM_LOGO_URL)
			VALUES (IN_TEAM_ID, IN_CBS_CODE, IN_ESPN_CODE, IN_FOX_CODE, IN_VEGAS_CODE,
					IN_CONFERENCE_CODE, IN_CONFERENCE_NAME, IN_DIVISION_NAME, IN_TEAM_NAME,
                    IN_TEAM_MASCOT, IN_G5_CONFERENCE, IN_TEAM_LOGO_URL);
    ...
    ELSE
        ...
        UPDATE TEAMS 
			SET 
				...
				G5_CONFERENCE = IN_G5_CONFERENCE, 
